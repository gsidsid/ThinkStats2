...
<p align="center">
  <img width="400" src="figures/cdf_ratings.jpg">
</p>
...
I went into the data analysis expecting to find that businesses with higher ratings, on average, have survival curves that indicate they are less probable to close than businesses with lower ratings. I've found that while there do exist marked differences in the survival curves among businesses with different ratings, the differences themselves are nothing like what I anticipated. Although some of the ratings conform to expectations, businesses with particularly bad ratings have a surprisingly low probability of closure, so much so as businesses with exceptional ratings. The clearest conclusion that could be drawn from this analysis, if any, is perhaps the difference in survival between the five star rated businesses and all the others, as the five star rated businesses have a far lower likelihood of closure than the others. 
